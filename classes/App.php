    ...
    public function __construct()
    {
        ...
        if (isset($_POST['rocket-edit'])) {
            if ($this->validateFormEdit()) {
                ...
                $rocket = new Rocket($_POST['rocket-edit-id'], $manufacturer_id, $this->imageName, $name, $human_rated, $payload, $height);
                ...
                $this->storage->updateRocket($_POST['rocket-edit-id'], $rocket);
            }
        }
    }
